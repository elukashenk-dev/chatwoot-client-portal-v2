...
describe('useAppViewportLock', () => {
  ...
  it('freezes vertical offset while the iOS keyboard pans the visual viewport', () => {
    const viewport = installVisualViewport({
      height: 780,
      offsetTop: 0,
      width: 390,
    ...
    viewport.setMetrics({ height: 540, offsetTop: 12 })
    viewport.fire('resize')
    ...
    viewport.setMetrics({ offsetTop: 44 })
    viewport.fire('scroll')
    ...
    viewport.setMetrics({ height: 780, offsetTop: 0 })
    viewport.fire('resize')
