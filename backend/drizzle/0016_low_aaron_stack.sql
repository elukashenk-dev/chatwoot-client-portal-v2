...
ALTER TABLE "portal_branding_settings" DROP CONSTRAINT IF EXISTS "portal_branding_settings_auth_header_asset_tenant_fk";
--> statement-breakpoint
ALTER TABLE "portal_branding_settings" DROP CONSTRAINT IF EXISTS "portal_branding_settings_auth_footer_asset_tenant_fk";
--> statement-breakpoint
...
ALTER TABLE "portal_branding_settings" DROP COLUMN IF EXISTS "auth_header_image_asset_id";--> statement-breakpoint
ALTER TABLE "portal_branding_settings" DROP COLUMN IF EXISTS "auth_footer_image_asset_id";--> statement-breakpoint
