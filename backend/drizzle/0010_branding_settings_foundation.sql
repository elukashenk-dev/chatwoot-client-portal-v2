...
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_logo_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("logo_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_auth_header_image_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("auth_header_image_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_auth_footer_image_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("auth_footer_image_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_auth_background_image_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("auth_background_image_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_chat_background_image_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("chat_background_image_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "portal_branding_settings" ADD CONSTRAINT "portal_branding_settings_chat_header_background_image_asset_id_portal_branding_assets_id_fk" FOREIGN KEY ("chat_header_background_image_asset_id") REFERENCES "public"."portal_branding_assets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
