import { and, count, eq, inArray, lt, or, type SQL } from 'drizzle-orm'
...
async function deleteChatMessageSends(
  db: AppDatabase,
  where: SQL | undefined,
) {
...
async function deleteWebhookDeliveries(db: AppDatabase, where: SQL | undefined) {
